...
def test_pythagorean_triplet():
    ...
    assert [solution_true, solution_false] == [expected_solution_true, expected_solution_false]


def test_collect_all_possible_sets_of_a_and_b():
    a_b_range = range(1,4)
...
def tests_calculate_c_given_a_and_b():
    a = 3
    b = 4
...
def tests_return_pythaogrean_triplet_that_meets_a_plus_b_plus_c_target():
